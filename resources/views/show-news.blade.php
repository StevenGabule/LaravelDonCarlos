            ...
            <div class="col-12 col-md-9">
                ...
                <script>
                    var disqus_config = function () {
                        this.page.url = "{!! route('news.detail',['slug' => $news->slug] ) !!}";  // Replace PAGE_URL with your page's canonical URL variable
                        this.page.identifier ="{!! route('news.detail',['slug' => $news->slug] ) !!}"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
                    };
