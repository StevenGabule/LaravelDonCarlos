...
@section('content')
    ...
    <div class="trending-bg-banner position-relative"
         style="background-image: url('https://images.unsplash.com/photo-1549880338-65ddcdfd017b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80');margin-top: -24px;">
        <div class="trending-bg-banner-overlay h-100 ">
            <div class="container col-dirtyWhite h-100">
                <div class="d-flex h-100">
                    <div class="mt-auto py-3">
                        <h2 class="d-inline-block px-4 py-2 bg-gold font-oswald-bold text-white text-uppercase">
                            {{ $content->title }}
                        </h2>
                ...
                <div class="col-12 col-sm-6 col-lg-4 pt-3">
                    <div class="card bg-light shadow-sm border-0">
                        <div>
                            ...
                            <img class="card-img max-height-250" src="{{ $post->avatar !== null ? asset('/backend/uploads/places/original/'.$post->avatar) : asset('assets/icons/mountains.svg') }}"
