...
@section('content')
    ...
    <div class="about-bg-banner position-relative"
         style="background-image: url('{{ $news->avatar !== null ? asset('/backend/uploads/service-article/'.$news->avatar) : 'https://images.unsplash.com/photo-1471899236350-e3016bf1e69e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1051&q=80' }}');margin-top: -24px;">
