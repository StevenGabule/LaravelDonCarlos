    ...
    <form id="baranggayForm" method="post" enctype="multipart/form-data" class="needs-validation">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
          ...
          <a href="{{ route('need-content.create') }}"
             class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            <i class="fad fa-plus mr-2"></i>New
          </a>

          <a href="/don-carlos/{{ $content->need_type === 1 ? 'award' : 'mandate' }}/{{$content->slug}}"
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  class="form-control form-control-sm">{{ $content->short_description }}</textarea>
              ...
              <div class="form-group">
                ...
                <textarea name="description" id="inputDescription"
                          class="form-control form-control-sm rounded-0">{{ $content->description }}</textarea>
            ...
            <div class="card-body">
              ...
              <div class="border h-75 text-center pb-5 pt-5 pl-5 pr-5 mb-3">
                @if($content->avatar !== null)
                  <img src="{{ asset('storage/uploads/content_needs/thumbnail' . '/' .$content->avatar) }}"
              ...
              <div class="form-group">
                ...
                <select name="need_type" id="inputNeedType" class="custom-select">
                  ...
                  <option value="1" {{ $content->need_type == 1 ? 'selected' : '' }}>Award</option>
                  <option value="2" {{ $content->need_type == 2 ? 'selected' : '' }}>Mandate</option>
                </select>
